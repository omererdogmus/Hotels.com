...
public class ThreeStarsHotelsPage {
	...
	public void showThreeStarsHotels() throws InterruptedException {
		elementUtil.doClick(threeStar);
		elementUtil.doClick(landmarks);
		elementUtil.doClick(airport);
		elementUtil.waitForElementPresent(distance);
		...
		System.out.println("Numbers of hotels that have 3 stars : " + starList.size());
		for(int i = 0; i < starList.size(); i++) {
			String list3Stars = starList.get(i).getText();
			System.out.println(list3Stars);
		}
	}
}
